...
export default function Services() {
  ...
  return (
    <section ref={sectionRef} id="services" className="scroll-mt-24 py-24 md:py-32 bg-black relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div ref={titleRef} className="text-center max-w-3xl mx-auto mb-20">
          ...
          <div className="reveal-header w-24 h-1 bg-neon-orange mx-auto mt-6 origin-center" />
        </div>
          ...
          {services.map((service, index) => {
            ...
            return (
              <motion.div
                ...
                className="service-card group relative p-8 md:p-10 rounded-2xl bg-deep-charcoal border border-white/5 transition-all duration-300 overflow-hidden flex flex-col justify-between h-full opacity-0"
              >
                {/* Accent Corner Glow */}
                <div 
